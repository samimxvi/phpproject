...
<body>
	...
	<header style="background-image: url(images/h1.jpg)">
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light">
				<a class="navbar-brand" href="index.php" style="color:white">
					<img src="images/hlogo1.png" width=110px height=110px>
				</a>
                <li class="nav-item">
					<b style="font-size:30px;"><p style="color:white; padding-top: 1px; padding-left: 1px;"><?php echo "WELCOME ".$_SESSION['username'];?></p></b>
      ...
      aria-haspopup="true" aria-expanded="false">Track</button>
						...
						<li class="nav-item">
							<a class="nav-link scroll" style="color:white" href="logout.php">logout</a>
						</li>
					</ul>
				</div>
			</nav>
		...
		<div class="container">
			<div class="banner-text">
				<div class="slider-info text-right">
					<h1 class="text-uppercase">Create and Admire Your Playlist.</h1>
					<p class="text-white">The key to one's heart is hidden in their playlist.</p>
