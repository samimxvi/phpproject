<?php
	...
	$mail->Username = 'vidyapragya1709ad@gmail.com';                 // SMTP username
	$mail->Password = 'vp17092099';                           // SMTP password
	$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
	$mail->Port = 587;                                    // TCP port to connect to
	$to=$_SESSION['email_address'];
	$mail->setFrom('vidyapragya1709ad@gmail.com', 'Musical World');
	...
	http://localhost/Musical-World-/verify.php?email_address=".$_SESSION['email_address']."&activation_code=".$_SESSION['activation_code']."  "; // Our message above including the link
