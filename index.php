...
<body>
	<!-- header -->
	<header style="background-image: url(images/h1.jpg)">
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light">
				<a class="navbar-brand" href="index.php" style="color:white">
					<img src="images/hlogo1.png" width=120px height=120px>
					Musical World
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav text-center ml-auto">
						<li class="nav-item  mr-3">
							<a class="nav-link scroll" style="color:white" href="#about" >about</a>
						</li>
						<li class="nav-item">
							<a class="nav-link scroll" style="color:white" href="" data-target="#modalLRForm" data-toggle="modal">Login/Signup</a>
						</li>
						<li class="nav-item">
							<a class="nav-link scroll" style="color:white" href="#contact">contact</a>
						</li>
				...
				<div class="card">
					<div class="card-body px-lg-5">
						...
						<p class="card-text align-self-center my-4 text-white">
							Are you a singer?
							But afraid to sing in front of a huge crowd.Then you are in the right place.Upload your songs to musical world and let the people listen to your songs and rate it.
						</p>
	...
	<div class="w3-contact py-5" id="contact" >
		<div class="container">
			<div class="row contact-form pt-md-5" style="color:#ACE7FF">
				<!-- contact details -->
	...
	<div class="cpy-right text-center">
		<p>© 2020 Musical World. All rights reserved</p>
	</div>
	<!-- //copyright -->
